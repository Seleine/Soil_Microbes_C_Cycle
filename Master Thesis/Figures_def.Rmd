...
gg_AS_f_Cont_A4 <- ggplot(data = micro) +
  geom_point(aes(x = GlcN_f, y = Contrib.A4_1)) +
  labs(y = "fungal GlcN", x = expression(paste("Contribution A4"))) +
  geom_smooth(method = lm, aes(x = GlcN_f, y = Contrib.A4_1), linetype = "dashed") +
  stat_cor(data = micro, aes(y = Contrib.A4_1, x = GlcN_f, label=paste(..rr.label.., ..p.label.., sep = "~`,`~")), colour = "black", label.y = 25) +
  theme_bw() +
  theme(axis.title = element_text(size = 10), legend.text = element_text(size = 10),
        legend.title = element_text(size = 10))

gg_AS_f_Cont_A5 <- ggplot(data = micro) +
  geom_point(aes(x = GlcN_f, y = Contrib.A5_1)) +
  labs(y = "fungal GlcN", x = expression(paste("Contribution A5"))) +
  #geom_smooth(method = lm, aes(x = GlcN_f, y = Contrib.A5_1), linetype = "dashed") +
  stat_cor(data = micro, aes(y = Contrib.A5_1, x = GlcN_f, label=paste(..rr.label.., ..p.label.., sep = "~`,`~")), colour = "black", label.y = 15) +
  theme_bw() +
  theme(axis.title = element_text(size = 10), legend.text = element_text(size = 10),
        legend.title = element_text(size = 10))
...
gg_AS_f_Cont_A4_A5 <- ggplot(data = micro) +
  geom_point(aes(x = GlcN_f, y = (Contrib.A4_1 + Contrib.A5_1))) +
  labs(y = expression(paste("Fungal Amino Sugars (soil g"^"-1",")")), x = "Contribution A4 and A5") +
  geom_smooth(method = lm, aes(x = GlcN_f, y = (Contrib.A4_1 + Contrib.A5_1)), linetype = "dashed") +
  stat_cor(data = micro, aes(y = (Contrib.A4_1 + Contrib.A5_1), x = GlcN_f, label=paste(..rr.label.., ..p.label.., sep = "~`,`~")), colour = "black", label.y = 35) +
  theme_bw() +
  theme(axis.title = element_text(size = 10), legend.text = element_text(size = 10),
        legend.title = element_text(size = 10))
