...
gfct_boxplot_moisture <- function(y_of_choice, y_label, ymax, x_label) {
  gg_boxplot <- ggplot(data = micro) +
...
ggsave("figures/gg_TOC1_20250512.png", plot = gg_TOC1)
```
...
# ggsave("figures/bla.png", plot = gg_AS_total)
